...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "ourproducts_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update ourproducts set nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1   = "insert into ourproducts(nama,foto,isi) values ('$nama','$foto_name','$isi')";
        }
...
?>
<h1>Halaman Admin Input Data Our Products</h1>
<div class="mb-3 row">
    <a href="ourproducts.php">
        << Kembali ke halaman admin Our Products</a>
</div>
<?php
if ($error) {
?>
