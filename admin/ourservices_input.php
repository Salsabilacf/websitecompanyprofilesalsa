...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "ourservices_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update ourservices set nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into ourservices(nama,foto,isi) values ('$nama','$foto_name','$isi')";
        }
...
?>
<h1>Halaman Admin Input Data ourservices</h1>
<div class="mb-3 row">
    <a href="ourservices.php">
        << Kembali ke halaman admin Oourservicess</a>
</div>
<?php
if ($error) {
?>
