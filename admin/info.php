    ...
    <tbody>
        ...
        if ($katakunci != '') {
            ...
            for ($x = 0; $x < count($array_katakunci); $x++) {
                $sqlcari[] = "(judul like '%" . $array_katakunci[$x] . "%' or  isi like '%" . $array_katakunci[$x] . "%' or isi like '%" . $array_katakunci[$x] . "%')";
            }
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="info.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Apakah yakin mau hapus data?')">
